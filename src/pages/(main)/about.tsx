  ...
  return (
    <>
      <PageMeta>
        <meta
          name="description"
          content="Learn more about the mission, vision, and impact of the Divine
              Mandate Humanitarian Foundation (DMHF)."
        />
        <title>DMHF | About Us</title>
      </PageMeta>
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="text-white">
                ...
                <p className="text-lg mb-4">
                  ...
                  agribusiness development, and fostering education in Nigeria.
                  We envision a Nigeria where everyone has access to nutritious
                  food, quality education, and economic opportunities.
                </p>
              </Card>
            </div>
          </motion.section>
